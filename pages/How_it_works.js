...
export default function HowItWorksPage() {
  return (
    <motion.section
      className="pt-32 pb-20 px-6 text-center bg-[url('/background.jpg')] bg-cover bg-center"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      >
        ...
        <div className="grid md:grid-cols-5 gap-6">
          {[
            ...
            <motion.div
              key={idx}
              className="bg-white/10 p-6 rounded-2xl shadow-lg text-center transition duration-500 hover:scale-105 hover:bg-white/20"
      ...
      >
        <motion.div
          className="bg-gradient-to-r from-purple-800 to-blue-900 rounded-2xl p-10 text-center"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
